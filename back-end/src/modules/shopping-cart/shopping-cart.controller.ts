...
export class ShoppingCartController {
  ...
  public async getShoppingCartFromUser(@Req() req: RequestWithAuth) {
    return await this.shoppingCartService.getShoppingCartFromUser(
      req.user.uuid,
    );
  }
  ...
  public async addProductToShoppingCart(
    ...
    return await this.shoppingCartService.addProductToShoppingCart(
      req.user.uuid,
      productId,
    );
  }
  ...
  public async removeProductFromShoppingCart(
    ...
    return await this.shoppingCartService.removeProductFromShoppingCart(
      req.user.uuid,
      productId,
    );
  }
